...
const CoochbeharAboutPage = () => {
  return (
    <div>
      {/* Hero Image Section */}
      <section className="hero-image-section" style={{height: '60vh', overflow: 'hidden'}}>
        <img 
          src="/pictures/coochbehar/coochbehar-banner.jpg"
          alt="TIGPS Campus" 
          ...
          <div className="row align-items-center">
            <div className="col-lg-8">
              ...
              <p style={{fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '20px', fontFamily: 'Lora'}}>
                TIGPS Coochbehar, began its journey in 2008 , affiliated under CBSE. It is a well known co-educational, English medium school located in Matikata,Madhupur More. School provides great opportunities through various activities to the children for their intellectual and aesthetic development. The faculty not only imparts knowledge but also encourages the students to take part in a variety of other ways like group activities, education technology, smart board classrooms, computer-aided learning, debate, quiz, etc. Numerous co-curricular activities are embedded in their academic programmes. The school has a separate activity room where yoga, dance, music, craft and similar things are taught.TIGPS Coochbehar attempts to encourage ways that would strengthen the potentials of students and bring out the best in them.
              </p>
            </div>
        ...
        <div style={{maxWidth: '1200px', margin: '0 auto'}}>
          ...
          <div className="row align-items-center" style={{marginBottom: '50px'}}>
            ...
            <div className="col-lg-5 mb-4">
              <img src="/pictures/coochbehar/coochbehar-about-us-mission-vission.png" alt="Mission and Vision" style={{width: '100%', borderRadius: '10px', boxShadow: '0 8px 20px rgba(0,0,0,0.1)'}}/>
            </div>
          </div>
            ...
            <div className="col-md-6 mb-4">
              <div style={{background: '#f8f9fa', padding: '40px', borderRadius: '10px', height: '100%', border: '2px solid rgb(100, 19, 32)'}}>
                ...
                <ul style={{textAlign: 'left', fontSize: '1rem', lineHeight: '1.6', color: '#333', fontFamily: 'Lora', listStyle: 'none', padding: '0'}}>
                  <li>• We strive to prepare dynamic and compassionate individuals, committed to the development of humanity who will meet the challenges of a global society while retaining their traditional values.</li>
                </ul>
              </div>
            </div>
            <div className="col-md-6 mb-4">
              <div style={{background: '#f8f9fa', padding: '40px', borderRadius: '10px', height: '100%', border: '2px solid rgb(100, 19, 32)'}}>
                ...
                <ul style={{textAlign: 'left', fontSize: '1rem', lineHeight: '1.6', color: '#333', fontFamily: 'Lora', listStyle: 'none', padding: '0'}}>
                  <li>• We are committed to shaping young minds to ensure that they develop the competencies essential for achieving success in every pursuit and leadership in the emerging creative economy.</li>
                </ul>
              </div>
            </div>
          </div>
...
export default CoochbeharAboutPage;