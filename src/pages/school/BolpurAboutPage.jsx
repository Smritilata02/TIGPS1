          ...
          <div className="row align-items-center">
            <div className="col-lg-8">
              ...
              <p style={{fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '20px', fontFamily: 'Lora'}}>
                TIGPS Bolpur offers a holistic educational experience with state-of-the-art infrastructure nestled in nature near Santiniketan, the revered abode of Nobel Laureate Kabiguru Rabindranath Tagore. Exclusive facilities include a well-stocked library, advanced computer, and science labs, GOI aided ATAL Tinkering Lab, spacious playgrounds, a swimming pool, and a canteen.</p>
              <p style={{fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '20px', fontFamily: 'Lora'}}>
                Beyond academics, students engage in diverse co-curricular activities such as music, dance, yoga, sports, learning foreign languages like French, Japanese, and Chinese, Archery, and fine arts, alongside co-scholastic pursuits like quizzes, debates, Abacus, elocution, extempore, photography, and journalism. With a strong emphasis on value-based education, we nurture intellectual, artistic, and ethical development, ensuring every TIGPSian emerges as a well-rounded individual, equipped with the knowledge, integrity, and a passion for value-based education.</p>
              <p style={{fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '0', fontFamily: 'Lora'}}>
                The school places a strong emphasis on 'Analytical Study' and 'Critical Thinking,' ensuring that students develop essential cognitive skills. Additionally, fostering a sense of 'social responsibility' is a key priority of TIGPS Bolpur. Students actively participate in initiatives such as visiting old age homes and orphanages, as well as distributing blankets and educational materials to nearby villages. A committed team of teaching and administrative officials continuously strives to provide the best opportunities for students. What sets this institution apart is its dedication to 'catering to the individual needs of each child while building a solid foundation of knowledge.

</p>
            </div>
            <div className="col-lg-4">
              <img 
                src="https://bolpur.tigps.in/assets/images/section-images/overview-image.jpg"
                alt="TIGPS Students" 
          ...
          <div className="row">
            <div className="col-md-6 mb-4">
              <div style={{background: '#f8f9fa', padding: '40px', borderRadius: '10px', height: '100%', border: '2px solid rgb(100, 19, 32)'}}>
                ...
                <ul style={{textAlign: 'left', fontSize: '1rem', lineHeight: '1.6', color: '#333', fontFamily: 'Lora', listStyle: 'none', padding: '0'}}>
                  <li style={{marginBottom: '15px'}}>• To provide diverse opportunities for passionate learners, fostering an entrepreneurial mindset, a spirit of innovation, empathy for others, and a deep understanding of the boundless potential of technology.</li>
            ...
            <div className="col-md-6 mb-4">
              <div style={{background: '#f8f9fa', padding: '40px', borderRadius: '10px', height: '100%', border: '2px solid rgb(100, 19, 32)'}}>
                ...
                <ul style={{textAlign: 'left', fontSize: '1rem', lineHeight: '1.6', color: '#333', fontFamily: 'Lora', listStyle: 'none', padding: '0'}}>
                  <li style={{marginBottom: '15px'}}>• To offer a unique state-of-the-art facility for passionate learners, equipping them with advanced technologies and essential skills to successfully navigate the challenges of the new millennium.</li>
...
export default BolpurAboutPage;