  ...
  return (
    <div>
      ...
      <section className="hero-image-section" style={{height: '60vh', overflow: 'hidden'}}>
        <img 
          src="/pictures/durgapur/durgapur-banner.jpg"
          alt="TIGPS Campus" 
          ...
          <div className="row align-items-center">
            <div className="col-lg-8">
              ...
              <p style={{fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '20px', fontFamily: 'Lora'}}>
               Techno India Group Public School Durgapur, established in 2015, leverages innovation to shape students' futures. This co-educational English medium school, in India's second planned city, follows a CBSE-affiliated curriculum (Affiliation No. 2430399) from pre-primary to senior secondary levels. Committed to holistic development, TIGPS Durgapur integrates academics with sports, extracurricular, and social awareness initiatives. With extensive indoor and outdoor sports facilities, it promotes physical well-being alongside intellectual growth. Programs like the Tobacco and Smoking Free campus by the Students Eco Club further enrich student engagement, ensuring a balanced educational experience. The school offers comprehensive health and hygiene care, interactive PSA activity classes, a modern cafeteria, and well-facilitated hostel accommodations for students. The management and teachers have carefully structured every aspect to foster each child's innate curiosity and love for learning.
              </p>
            </div>
          ...
          <div className="row align-items-center" style={{marginBottom: '50px'}}>
            <div className="col-lg-7 mb-4">
              <p style={{fontSize: '1.1rem', lineHeight: '1.8', color: '#333', fontFamily: 'Lora', textAlign: 'left'}}>
                Techno India Group Public School Durgapur, established in 2015, leverages innovation to shape students' futures. This co-educational English medium school, in India's second planned city, follows a CBSE-affiliated curriculum (Affiliation No. 2430399) from pre-primary to senior secondary levels. Committed to holistic development, TIGPS Durgapur integrates academics with sports, extracurricular, and social awareness initiatives. 
              </p>
            </div>
            <div className="col-lg-5 mb-4">
              <img src="/pictures/durgapur/durgapur-about-us-mission-vission.png" alt="Mission and Vision" style={{width: '100%', borderRadius: '10px', boxShadow: '0 8px 20px rgba(0,0,0,0.1)'}}/>
            </div>
          </div>
            ...
            <div className="col-md-6 mb-4">
              <div style={{background: '#f8f9fa', padding: '40px', borderRadius: '10px', height: '100%', border: '2px solid rgb(100, 19, 32)'}}>
                ...
                <ul style={{textAlign: 'left', fontSize: '1rem', lineHeight: '1.6', color: '#333', fontFamily: 'Lora', listStyle: 'none', padding: '0'}}>
                  <li>• To provide opportunities to keen learners, driven by entrepreneurial innovation, empowered by empathy, and guided by the wisdom to harness technology’s limitless potential.</li>
                </ul>
              </div>
            </div>
            <div className="col-md-6 mb-4">
              <div style={{background: '#f8f9fa', padding: '40px', borderRadius: '10px', height: '100%', border: '2px solid rgb(100, 19, 32)'}}>
                ...
                <ul style={{textAlign: 'left', fontSize: '1rem', lineHeight: '1.6', color: '#333', fontFamily: 'Lora', listStyle: 'none', padding: '0'}}>
                  <li>• To introduce an innovative and advanced learning environment in the country and to cultivate skilled and visionary professionals who are equipped to tackle the challenges of the new millennium.</li>
                </ul>
              </div>
            </div>
          </div>
