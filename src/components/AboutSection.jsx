...
const AboutSection = ({ title, paragraphs, image }) => {
  ...
  return (
    <section className="about-section">
      <div className="about-container">
        <h2 ref={titleRef} className="about-title">{title}</h2>
...
/* ✅ Default content (used by other schools) */
AboutSection.defaultProps = {
  ...
  image: "/pictures/home/franchise-enquiry.jpg"
};
